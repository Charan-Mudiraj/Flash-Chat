...
1. User Auth
   ...
   <img src="./views/1.jpg" height="700px">

2. Register

   <img src="./views/2.jpg" height="700px">

3. Login - user login status is stored in device memory

   <img src="./views/3.jpg" height="700px">

4. Add group feature

   <img src="./views/4.jpg" height="700px">

5. Additional group features

   <img src="./views/5.jpg" height="700px">

6. Chat screen

   <img src="./views/6.jpg" height="700px">

7. Logout Confirmation to remove user's login status from device memory.

   <img src="./views/7.jpg" height="700px">

8. Auth validation fail case

   <img src="./views/8.jpg" height="700px">
